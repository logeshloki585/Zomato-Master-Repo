...
const MediumNav = () => {
 return  <>
    <div className="hidden flex w-full items-center justify-between border border-gray-200 md:flex">
        <div className="w-28 ">
            <img className="w-full height-full" src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png" alt="logo" />
        </div>
        <div className="w-full flex bg white shadow-md px-3 py-3 items-center border gap-3 border-gray-200 rounded">
